...
from pulze_ai_python_sdk.model.pulze_engine_model_ranking import PulzeEngineModelRanking as PulzeEngineModelRankingSchema
...
from pulze_ai_python_sdk.type.pulze_engine_model_ranking import PulzeEngineModelRanking
...
from pulze_ai_python_sdk.pydantic.pulze_engine_model_ranking import PulzeEngineModelRanking as PulzeEngineModelRankingPydantic
...
SchemaFor200ResponseBodyApplicationJson = PulzeEngineModelRankingSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PulzeEngineModelRanking
...
class BaseApi(api_client.Api):
    ...
    def _get_rank_of_best_mapped_args(
        self,
    ...
    async def _aget_rank_of_best_oapg(
        self,
...
class GetRankOfBestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_rank_of_best(
        self,
        best_of: typing.Optional[int] = None,
        _false: typing.Optional[int] = None,
        frequency_penalty: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._get_rank_of_best_mapped_args(
            best_of=best_of,
            _false=_false,
        ...
        return await self._aget_rank_of_best_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_rank_of_best(
        self,
        best_of: typing.Optional[int] = None,
        _false: typing.Optional[int] = None,
        frequency_penalty: typing.Optional[typing.Union[int, float]] = None,
        ...
        return self._get_rank_of_best_oapg(
            body=args.body,
        )

class GetRankOfBest(BaseApi):
    ...
    async def aget_rank_of_best(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PulzeEngineModelRankingPydantic:
        raw_response = await self.raw.aget_rank_of_best(
            best_of=best_of,
            _false=_false,
            frequency_penalty=frequency_penalty,
            logit_bias=logit_bias,
        ...
        if validate:
            return PulzeEngineModelRankingPydantic(**raw_response.body)
        return api_client.construct_model_instance(PulzeEngineModelRankingPydantic, raw_response.body)
    ...
    def get_rank_of_best(
        ...
        raw_response = self.raw.get_rank_of_best(
            best_of=best_of,
            _false=_false,
            frequency_penalty=frequency_penalty,
            logit_bias=logit_bias,
