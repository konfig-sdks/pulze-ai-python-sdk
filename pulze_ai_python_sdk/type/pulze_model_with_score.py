...
class RequiredPulzeModelWithScore(TypedDict):
...
class OptionalPulzeModelWithScore(TypedDict, total=False):
...
class PulzeModelWithScore(RequiredPulzeModelWithScore, OptionalPulzeModelWithScore):
    pass
