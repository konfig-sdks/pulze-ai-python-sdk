...
class RequiredPulzeEngineResponse(TypedDict):
...
class OptionalPulzeEngineResponse(TypedDict, total=False):
    ...
    choices: typing.Union[typing.List[ResponseCompletionChatChoice], typing.List[ResponseCompletionChoice]]
...
class PulzeEngineResponse(RequiredPulzeEngineResponse, OptionalPulzeEngineResponse):
    pass
