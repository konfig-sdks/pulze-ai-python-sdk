...
class RequiredPulzeDefaultModelData(TypedDict):
...
class OptionalPulzeDefaultModelData(TypedDict, total=False):
...
class PulzeDefaultModelData(RequiredPulzeDefaultModelData, OptionalPulzeDefaultModelData):
    pass
