...
class RequiredPaymentDetailsLimits(TypedDict):
    pass

class OptionalPaymentDetailsLimits(TypedDict, total=False):
...
class PaymentDetailsLimits(RequiredPaymentDetailsLimits, OptionalPaymentDetailsLimits):
    pass
