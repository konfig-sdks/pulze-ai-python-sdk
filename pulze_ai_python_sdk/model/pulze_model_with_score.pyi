...
class PulzeModelWithScore(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["model", "namespace", "at", "owner", "provider", "score", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["model", "namespace", "at", "owner", "provider", "score", ], str]):
