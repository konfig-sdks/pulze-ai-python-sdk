...
class PlatformFeedbackBody(
    ...
    class MetaOapg:
        ...
        class properties:
            source_details = schemas.StrSchema
            __annotations__ = {
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["source_details", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["source_details", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        source_details: typing.Union[MetaOapg.properties.source_details, str, ],
