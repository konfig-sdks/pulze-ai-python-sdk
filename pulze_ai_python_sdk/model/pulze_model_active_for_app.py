...
class PulzeModelActiveForApp(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "context_window", "model", "namespace", "url", "active", "at", "id", "owner", "provider", "until", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "context_window", "model", "namespace", "url", "active", "at", "id", "owner", "provider", "until", ], str]):
