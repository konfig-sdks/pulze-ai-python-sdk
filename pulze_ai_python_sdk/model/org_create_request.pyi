...
class OrgCreateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["org_name", "org_display_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["org_name", "org_display_name", ], str]):
