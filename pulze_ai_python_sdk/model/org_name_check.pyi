...
class OrgNameCheck(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["org_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["org_name", ], str]):
