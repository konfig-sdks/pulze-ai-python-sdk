...
class CompletionRequestPayload(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["best_of", "false", "frequency_penalty", "logit_bias", "logprobs", "max_tokens", "messages", "model", "presence_penalty", "prompt", "stop", "stream", "suffix", "temperature", "tool_choice", "tools", "top_p", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["best_of", "false", "frequency_penalty", "logit_bias", "logprobs", "max_tokens", "messages", "model", "presence_penalty", "prompt", "stop", "stream", "suffix", "temperature", "tool_choice", "tools", "top_p", ], str]):
