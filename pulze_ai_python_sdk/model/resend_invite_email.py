...
class ResendInviteEmail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "invite_link", "org_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "invite_link", "org_id", ], str]):
