...
class LogResponseRatingRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["feedback", "good_answer", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["feedback", "good_answer", ], str]):
