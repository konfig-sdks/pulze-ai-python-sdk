...
class ModelDataUpdatePayloadForInternal(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "app_id", "at", "base_cost", "completion_token_cost", "context_window", "default_active", "is_public", "model", "org_id", "owner", "prompt_token_cost", "provider", "until", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "app_id", "at", "base_cost", "completion_token_cost", "context_window", "default_active", "is_public", "model", "org_id", "owner", "prompt_token_cost", "provider", "until", "url", ], str]):
