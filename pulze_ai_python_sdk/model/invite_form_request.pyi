...
class InviteFormRequest(
        ...
        class properties:
            ...
            class emails(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['InviteFormEmail']:
                        return InviteFormEmail
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['InviteFormEmail'], typing.List['InviteFormEmail']],
                ...
                def __getitem__(self, i: int) -> 'InviteFormEmail':
                    return super().__getitem__(i)
            invite_link = schemas.StrSchema
            __annotations__ = {
                "emails": emails,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["emails", "invite_link", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["emails", "invite_link", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        invite_link: typing.Union[MetaOapg.properties.invite_link, str, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
