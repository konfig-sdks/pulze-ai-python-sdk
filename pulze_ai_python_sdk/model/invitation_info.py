...
class InvitationInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "token", ], str]):
