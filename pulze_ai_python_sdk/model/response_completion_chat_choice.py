...
class ResponseCompletionChatChoice(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def message() -> typing.Type['RoleContentChatChoice']:
    ...
    message: 'RoleContentChatChoice'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["index"]) -> MetaOapg.properties.index: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["message"]) -> 'RoleContentChatChoice': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["index", "message", "finish_reason", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["message"]) -> 'RoleContentChatChoice': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["index", "message", "finish_reason", ], str]):
