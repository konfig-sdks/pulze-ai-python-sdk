...
class OrgIntegrationItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["endpoint", "id", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["endpoint", "id", "token", ], str]):
