...
class LLMModelPolicies(BaseModel):
    ...
    max_cost: typing.Optional[typing.Union[int, float]] = Field(None, alias='max_cost')
    ...
    max_same_model_retries: typing.Optional[int] = Field(None, alias='max_same_model_retries')
    ...
    max_switch_model_retries: typing.Optional[int] = Field(None, alias='max_switch_model_retries')
    ...
    optimize_internal_requests: typing.Optional[Literal[0, 1]] = Field(None, alias='optimize_internal_requests')
