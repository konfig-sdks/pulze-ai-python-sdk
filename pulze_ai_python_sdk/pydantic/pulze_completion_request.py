...
from pulze_ai_python_sdk.pydantic.pulze_completion_request_headers import PulzeCompletionRequestHeaders
from pulze_ai_python_sdk.pydantic.pulze_completion_request_labels import PulzeCompletionRequestLabels
...
class PulzeCompletionRequest(BaseModel):
    ...
    headers: typing.Optional[PulzeCompletionRequestHeaders] = Field(None, alias='headers')

    labels: typing.Optional[PulzeCompletionRequestLabels] = Field(None, alias='labels')
